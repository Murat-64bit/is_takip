    ...
    public partial class FrmProductHistory : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void btnkaydet_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            komut3.ExecuteNonQuery();
                bgl.baglanti().Close();
                SqlCommand komut4 = new SqlCommand("update TBLURUNLER set depogiris=depogiris-@t1 where profilno=@t2", bgl.baglanti());
                komut4.Parameters.AddWithValue("@t1", txtadet.EditValue);
                komut4.Parameters.AddWithValue("@t2", txtprofilno.EditValue);
