...
namespace ForzaYazilim
{
    public partial class FrmAnaSayfa : DevExpress.XtraBars.FluentDesignSystem.FluentDesignForm
    {
        ...
        {
            if (!container.Controls.Contains(FrmHareketler.Instance))
            {
                container.Controls.Add(FrmHareketler.Instance);
                FrmHareketler.Instance.Dock = DockStyle.Fill;
                FrmHareketler.Instance.BringToFront();
